...
/* TODO: Check all GPIO deltas - WiFi, touch, WAN ... */
#define MX6_WOODY_KEYPAD_NEXT           IMX_GPIO_NR(5, 14)    /* SD1_CMD */
#define MX6_WOODY_KEYPAD_PREV           IMX_GPIO_NR(5, 11)    /* SD1_DAT0 */
...
#define I2C_INIT                        gpio_direction_output(MX6_SODA_I2C_SCL, 1)
#define I2C_ACTIVE                      gpio_direction_output(MX6_SODA_I2C_SDA, 1)
#define I2C_TRISTATE                    gpio_direction_input(MX6_SODA_I2C_SDA) 
#define I2C_READ                        gpio_get_value(MX6_SODA_I2C_SDA)
#define I2C_SDA(bit)                    if (bit) gpio_set_value(MX6_SODA_I2C_SDA, 1); \
                                        else     gpio_set_value(MX6_SODA_I2C_SDA, 0)
#define I2C_SCL(bit)                    if (bit) gpio_set_value(MX6_SODA_I2C_SCL, 1); \
                                        else     gpio_set_value(MX6_SODA_I2C_SCL, 0)
#define I2C_DELAY                       udelay(20)   

#define SODA_CHG_I2C_ADDR               (0x36>>1)   
#define SODA_FG_I2C_ADDR                (0xAA>>1)
#define SODA_EEPROM_I2C_ADDR            (0xA0>>1)	/* VNI Fixture EEPROM */
