...
#define MX6SL_USDHC_PAD_CTRL_LVE (PAD_CTL_PKE | PAD_CTL_PUE |		\
		PAD_CTL_PUS_22K_UP  | PAD_CTL_SPEED_LOW | PAD_CTL_LVE |	\
		PAD_CTL_DSE_80ohm   | PAD_CTL_SRE_FAST  | PAD_CTL_HYS)
...
#define MX6SL_ECSPI_PAD_CTRL (PAD_CTL_SRE_FAST | PAD_CTL_SPEED_MED |	\
		PAD_CTL_DSE_40ohm   | PAD_CTL_HYS | PAD_CTL_PUE)

#define MX6SL_EPDC_SDSHR_PAD_CTRL (PAD_CTL_LVE_REG | PAD_CTL_HYS |  \
